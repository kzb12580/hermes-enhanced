...
| 平台 | 文件 | 说明 |
|------|------|------|
| 🪟 Windows | `hermes-desktop-0.1.0-setup.exe` | 安装版 |
| 🪟 Windows | `Hermes-Desktop-0.1.0-win.zip` | 便携版（解压即用） |
| 🍎 macOS Intel | `Hermes-Desktop-0.1.0-mac.zip` | Intel 芯片 |
| 🍎 macOS ARM | `Hermes-Desktop-0.1.0-arm64-mac.zip` | M1/M2/M3/M4 |
| 🐧 Linux | `hermes-desktop-0.1.0.AppImage` | 通用版 |

**下载地址：** [GitHub Releases](https://github.com/kzb12580/hermes-enhanced/releases/tag/v0.1.0)
